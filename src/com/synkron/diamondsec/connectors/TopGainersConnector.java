...
public class TopGainersConnector extends InfoWareConnector{

	public TopGainersConnector(String Url) {
		super(Url);
		...
		try{
            ...
            UiApplication.getUiApplication().invokeLater(new Runnable(){
            	public void run(){
            		...
            		theScreen._topGainers.deleteAll();
            		...
            		try{
						...
						for(int i = 0; i < jsonArray.length(); i++){
							...
							theScreen._topGainers.add(lsBtnField);
