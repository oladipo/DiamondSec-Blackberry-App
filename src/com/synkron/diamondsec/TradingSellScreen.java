...
import com.synkron.diamondsec.entities.Trade;
...
public class TradingSellScreen extends SubScreen implements FieldChangeListener{
	...
	public void SetupTradingScreen(){
		...
		_lblPriceCurrent.setText(theStock._currentPrice);
		...
		_txtFieldAmount.setFilter(TextFilter.get(TextFilter.REAL_NUMERIC));
	...
	public void fieldChanged(Field field, int context) {
		UiApplication diamondSec = UiApplication.getUiApplication();
			...
			if(field == _btnConfirm){
				...
				//build endpoint URL..
				URL = URL + strCustomerNumber + "|"+strCSCSNumber +"|"+theStock._ticker+
				...
				String strPlaceParams = strCustomerNumber + "|"+strCSCSNumber +"|"+theStock._ticker+
				"|"+TRADE_ACTION+"|"+_txtFieldAmount.getText()+"|"+ORDER_TYPE+"|"+_txtFieldPrice.getText()+
